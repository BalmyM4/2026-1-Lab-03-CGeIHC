...
int main()
{
	...
	mainLight = DirectionalLight(1.0f, 1.0f, 1.0f,
		0.3f, 0.3f,									// Intensidad ambiental: se aumenta la intensidad desde todos lsados
		0.0f, 0.0f, -1.0f);							// Intensidad direccional: se aumenta la intensidad desde la dirección
	...
	glm::vec3 baseLightPosH(-2.7f, -0.7f, 0.45f);
	glm::vec3 baseLightPos(2.1f, 0.0f, 0.75f);
	glm::vec3 newPos;
	GLfloat mx = 0;
	...
	while (!mainWindow.getShouldClose())
	{
		...
		// Movimiento de la luz
		newPos = glm::vec3(model * glm::vec4(baseLightPos, 1.0f));
		spotLights[1].SetPos(newPos);
