...
int main()
{
	...
	*/
	camera = Camera(glm::vec3(0.0f, 0.0f, 0.0f), glm::vec3(0.0f, 1.0f, 0.0f), -80.0f, 0.0f, 0.2f, 0.2f);
	...
	glm::mat4 modelbase(1.0);//Inicializar matriz de Modelo 4x4 auxiliar para la jerarquía
	glm::mat4 modelBase(1.0);//Inicializar matriz de Modelo 4x4 auxiliar para la jerarquía
	glm::mat4 modelarm(1.0);
	...
	while (!mainWindow.getShouldClose())
	{
		...
		color = glm::vec3(0.7098f, 0.502f, 0.1647f);
		...
		model = glm::rotate(model, glm::radians(35.0f), glm::vec3(0.0f, 0.0f, 1.0f));
		model = glm::scale(model, glm::vec3(1.2f, 4.0f, 1.2f));
		...
		model = glm::rotate(model, glm::radians(90.0f), glm::vec3(0.0f, 0.0f, 1.0f));
		model = glm::scale(model, glm::vec3(0.8f, 2.1f, 1.22f));
		...
		// Dentadura superior [0] ---------------------------------------------------------------------------
		model = modelaux;
		model = glm::translate(model, glm::vec3(-0.6f, -0.65f, 1.125f));
		...
		// Dentadura superior [1]
		model = glm::translate(model, glm::vec3(-1.2f, 0.0f, 0.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[4]->RenderMesh(); //dibuja cubo, pirámide triangular, pirámide base cuadrangular

		// Dentadura superior [2]
		model = glm::translate(model, glm::vec3(-1.2f, 0.0f, 0.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[4]->RenderMesh(); //dibuja cubo, pirámide triangular, pirámide base cuadrangular

		// Dentadura superior [3]
		model = glm::translate(model, glm::vec3(-1.2f, 0.0f, 0.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[4]->RenderMesh(); //dibuja cubo, pirámide triangular, pirámide base cuadrangular

		// Dentadura superior [4]
		model = glm::translate(model, glm::vec3(-1.2f, 0.0f, 0.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[4]->RenderMesh(); //dibuja cubo, pirámide triangular, pirámide base cuadrangular

		// Dentadura superior [5]
		model = glm::translate(model, glm::vec3(0.0f, 0.0f, -1.2f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[4]->RenderMesh(); //dibuja cubo, pirámide triangular, pirámide base cuadrangular

		// Dentadura superior [6]
		model = glm::translate(model, glm::vec3(0.0f, 0.0f, -1.2f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[4]->RenderMesh(); //dibuja cubo, pirámide triangular, pirámide base cuadrangular

		// Dentadura superior [7]
		model = glm::translate(model, glm::vec3(0.0f, 0.0f, -1.2f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[4]->RenderMesh(); //dibuja cubo, pirámide triangular, pirámide base cuadrangular

		// Dentadura superior [8]
		model = glm::translate(model, glm::vec3(0.0f, 0.0f, -1.2f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[4]->RenderMesh(); //dibuja cubo, pirámide triangular, pirámide base cuadrangular

		// Dentadura superior [9]
		model = glm::translate(model, glm::vec3(0.0f, 0.0f, -1.2f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[4]->RenderMesh(); //dibuja cubo, pirámide triangular, pirámide base cuadrangular

		// Dentadura superior [10]
		model = glm::translate(model, glm::vec3(0.0f, 0.0f, -1.2f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[4]->RenderMesh(); //dibuja cubo, pirámide triangular, pirámide base cuadrangular

		// Dentadura superior [11]
		model = glm::translate(model, glm::vec3(1.2f, 0.0f, -0.2f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[4]->RenderMesh(); //dibuja cubo, pirámide triangular, pirámide base cuadrangular

		// Dentadura superior [12]
		model = glm::translate(model, glm::vec3(1.2f, 0.0f, -0.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[4]->RenderMesh(); //dibuja cubo, pirámide triangular, pirámide base cuadrangular

		// Dentadura superior [13]
		model = glm::translate(model, glm::vec3(1.2f, 0.0f, -0.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[4]->RenderMesh(); //dibuja cubo, pirámide triangular, pirámide base cuadrangular

		// Dentadura superior [14]
		model = glm::translate(model, glm::vec3(1.2f, 0.0f, -0.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[4]->RenderMesh(); //dibuja cubo, pirámide triangular, pirámide base cuadrangular
		...
		// Articulación dde la mandubula inferior
		model = modelbase;
		model = glm::translate(model, glm::vec3(1.0f, -1.25f, 0.0f));
		...
		// Dentadura inferior [0] ---------------------------------------------------------------------------
		model = modelaux;
		model = glm::translate(model, glm::vec3(-0.5f, 0.325f, 0.93f));
		...
		// Dentadura inferior [1]
		model = glm::translate(model, glm::vec3(1.2f, 0.0f, 0.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[4]->RenderMesh(); //dibuja cubo, pirámide triangular, pirámide base cuadrangular

		// Dentadura inferior [2]
		model = glm::translate(model, glm::vec3(1.2f, 0.0f, 0.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[4]->RenderMesh(); //dibuja cubo, pirámide triangular, pirámide base cuadrangular

		// Dentadura inferior [3]
		model = glm::translate(model, glm::vec3(1.2f, 0.0f, 0.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[4]->RenderMesh(); //dibuja cubo, pirámide triangular, pirámide base cuadrangular

		// Dentadura inferior [4]
		model = glm::translate(model, glm::vec3(1.2f, 0.0f, 0.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[4]->RenderMesh(); //dibuja cubo, pirámide triangular, pirámide base cuadrangular

		// Dentadura inferior [5]
		model = glm::translate(model, glm::vec3(1.2f, 0.0f, 0.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[4]->RenderMesh(); //dibuja cubo, pirámide triangular, pirámide base cuadrangular

		// Dentadura inferior [6]
		model = glm::translate(model, glm::vec3(1.2f, 0.0f, 0.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[4]->RenderMesh(); //dibuja cubo, pirámide triangular, pirámide base cuadrangular

		// Dentadura inferior [7]
		model = glm::translate(model, glm::vec3(1.2f, 0.0f, 0.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[4]->RenderMesh(); //dibuja cubo, pirámide triangular, pirámide base cuadrangular

		// Dentadura inferior [8]
		model = glm::translate(model, glm::vec3(0.0f, 0.0f, -1.2f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[4]->RenderMesh(); //dibuja cubo, pirámide triangular, pirámide base cuadrangular

		// Dentadura inferior [9]
		model = glm::translate(model, glm::vec3(0.0f, 0.0f, -1.2f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[4]->RenderMesh(); //dibuja cubo, pirámide triangular, pirámide base cuadrangular

		// Dentadura inferior [10]
		model = glm::translate(model, glm::vec3(0.0f, 0.0f, -1.2f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[4]->RenderMesh(); //dibuja cubo, pirámide triangular, pirámide base cuadrangular

		// Dentadura inferior [11]
		model = glm::translate(model, glm::vec3(0.0f, 0.0f, -1.2f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[4]->RenderMesh(); //dibuja cubo, pirámide triangular, pirámide base cuadrangular

		// Dentadura inferior [12]
		model = glm::translate(model, glm::vec3(0.0f, 0.0f, -1.2f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[4]->RenderMesh(); //dibuja cubo, pirámide triangular, pirámide base cuadrangular

		// Dentadura inferior [13]
		model = glm::translate(model, glm::vec3(0.0f, 0.0f, -1.2f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[4]->RenderMesh(); //dibuja cubo, pirámide triangular, pirámide base cuadrangular

		// Dentadura inferior [14]
		model = glm::translate(model, glm::vec3(0.0f, 0.0f, -1.2f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[4]->RenderMesh(); //dibuja cubo, pirámide triangular, pirámide base cuadrangular

		// Dentadura inferior [15]
		model = glm::translate(model, glm::vec3(0.0f, 0.0f, -1.2f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[4]->RenderMesh(); //dibuja cubo, pirámide triangular, pirámide base cuadrangular

		// Dentadura inferior [16]
		model = glm::translate(model, glm::vec3(0.0f, 0.0f, -1.2f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[4]->RenderMesh(); //dibuja cubo, pirámide triangular, pirámide base cuadrangular

		// Dentadura inferior [17]
		model = glm::translate(model, glm::vec3(0.0f, 0.0f, -1.2f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[4]->RenderMesh(); //dibuja cubo, pirámide triangular, pirámide base cuadrangular

		// Dentadura inferior [18]
		model = glm::translate(model, glm::vec3(-1.2f, 0.0f, -0.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[4]->RenderMesh(); //dibuja cubo, pirámide triangular, pirámide base cuadrangular

		// Dentadura inferior [19]
		model = glm::translate(model, glm::vec3(-1.2f, 0.0f, -0.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[4]->RenderMesh(); //dibuja cubo, pirámide triangular, pirámide base cuadrangular

		// Dentadura inferior [20]
		model = glm::translate(model, glm::vec3(-1.2f, 0.0f, -0.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[4]->RenderMesh(); //dibuja cubo, pirámide triangular, pirámide base cuadrangular

		// Dentadura inferior [21]
		model = glm::translate(model, glm::vec3(-1.2f, 0.0f, -0.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[4]->RenderMesh(); //dibuja cubo, pirámide triangular, pirámide base cuadrangular
		...
		// Dentadura inferior [22]
		model = glm::translate(model, glm::vec3(-1.2f, 0.0f, -0.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[4]->RenderMesh(); //dibuja cubo, pirámide triangular, pirámide base cuadrangular

		// Dentadura inferior [23]
		model = glm::translate(model, glm::vec3(-1.2f, 0.0f, -0.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[4]->RenderMesh(); //dibuja cubo, pirámide triangular, pirámide base cuadrangular

		// Dentadura inferior [24]
		model = glm::translate(model, glm::vec3(-1.2f, 0.0f, -0.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[4]->RenderMesh(); //dibuja cubo, pirámide triangular, pirámide base cuadrangular
		...
		modelaux = model;
		model = glm::scale(model, glm::vec3(3.0f, 3.25f, 3.5f));
		...
		modelaux = model;
		model = glm::scale(model, glm::vec3(3.0f, 1.75f, 2.0f));
		...
		modelaux = model;
		model = glm::rotate(model, glm::radians(90.0f), glm::vec3(0.0f, 0.0f, 1.0f));
		model = glm::scale(model, glm::vec3(0.75f, 3.0f, 1.0f));
		...
		// Articulación de la pantorrilla [3]
		model = modelaux;
		...
		modelaux = model;
		model = glm::scale(model, glm::vec3(2.0f, 1.25f, 1.5f));
		...
		modelaux = model;
		model = glm::scale(model, glm::vec3(0.5f, 1.25f, 1.5f));
		...
		model = glm::scale(model, glm::vec3(0.45f, 0.75f, 0.45f));
		...
		color = glm::vec3(0.5098f, 0.3569f, 0.1137f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[0]->RenderMesh(); //dibuja cubo, pirámide triangular, pirámide base cuadrangularb
		...
		// Articulación del bisep [1]
		model = modelarm;
		model = glm::translate(model, glm::vec3(1.2f, -1.25f, 1.5f));
		...
		modelaux = model;
		model = glm::scale(model, glm::vec3(1.25f, 0.5f, 0.5f));
		...
		// Dedo [3,1] ------------------------------------------------------------------------------------
		model = modelaux;
		model = glm::translate(model, glm::vec3(0.4f, -0.15f, 0.2f));
		model = glm::rotate(model, glm::radians(25.0f), glm::vec3(0.0f, 0.0f, 1.0f));
		...
		model = glm::scale(model, glm::vec3(0.75f, 0.9f, 0.75f));
		...
		// Cabina --------------------------------------------------------------------------------------------
		model = glm::translate(model, glm::vec3(30.0f, 6.0f, -30.0f));


		//articulación 5 -------------------------------------------------------------------------------------

		//rotación alrededor de la base
		modelBase = model;
		...
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.6706f, 0.5922f, 0.4078f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[0]->RenderMesh(); //dibuja cubo, pirámide triangular, pirámide base cuadrangular
		...
		modelBase = model;
		model = glm::scale(model, glm::vec3(5.0f, 1.5f, 3.0f));

		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.451f, 0.4314f, 0.3686f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[4]->RenderMesh(); //dibuja cubo, pirámide triangular, pirámide base cuadrangular
		...
		modelBase = model;
		model = glm::translate(model, glm::vec3(-1.65f, -1.5f, -0.6f));

		model = glm::rotate(model, -1 * glm::radians(mainWindow.getarticulacion15()), glm::vec3(0.0f, 1.0f, 0.0f));

		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.4902f, 0.1882f, 0.1333f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[2]->RenderMeshGeometry(); //dibuja las figuras geométricas cilindro y cono
		...
		model = glm::rotate(model, -1 * glm::radians(mainWindow.getarticulacion16()), glm::vec3(0.0f, 1.0f, 0.0f));
		...
		model = glm::rotate(model, -1 * glm::radians(mainWindow.getarticulacion17()), glm::vec3(0.0f, 1.0f, 0.0f));
		...
		model = glm::rotate(model, -1 * glm::radians(mainWindow.getarticulacion18()), glm::vec3(0.0f, 1.0f, 0.0f));
		...
		glUniformMatrix4fv(uniformProjection, 1, GL_FALSE, glm::value_ptr(projection));
		glUniformMatrix4fv(uniformView, 1, GL_FALSE, glm::value_ptr(camera.calculateViewMatrix()));
		color = glm::vec3(0.7412f, 0.5961f, 0.1098f);
		...
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.4784f, 0.3686f, 0.0471f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color)); //para cambiar el color del objetos
		...
		model = modelaux;
		model = glm::translate(model, glm::vec3(2.5f, 0.0f, 0.0f));
		model = glm::rotate(model, -1 * glm::radians(mainWindow.getarticulacion19()), glm::vec3(0.0f, 0.0f, 1.0f));
		model = glm::rotate(model, -1 * glm::radians(mainWindow.getarticulacion20()), glm::vec3(0.0f, 0.0f, 1.0f));
		model = glm::rotate(model, -1 * glm::radians(mainWindow.getarticulacion21()), glm::vec3(0.0f, 0.0f, 1.0f));
		...
		modelaux = model;
		model = glm::rotate(model, glm::radians(-135.0f), glm::vec3(0.0f, 0.0f, 1.0f));
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion22()), glm::vec3(0.0f, 1.0f, 0.0f));
		model = glm::scale(model, glm::vec3(2.0f, 2.5f, 2.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.4392f, 0.3686f, 0.1804f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color)); //para cambiar el color del objetos
		meshList[0]->RenderMesh(); //dibuja cubo y pirámide triangular
